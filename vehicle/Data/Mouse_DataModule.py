...
class MouseModule(pl.LightningDataModule):
    ...
    class MouseDataset(Dataset):
        def __init__(self,
            ...
            assert tvt in ['train', 'val',
                           'test'], 'tvt can be `train`, `val` or `test`'
    ...
    def setup(self,
        ...
        if stage == 'fit':
            self.train_set = self.MouseDataset(
                tvt='train', data_path=data_path, target_path=target_path, indexes_path=indexes_path)
            self.val_set = self.MouseDataset(
                tvt='val', data_path=data_path, target_path=target_path, indexes_path=indexes_path)
        if stage == 'test':
            self.test_set = self.MouseDataset(
                tvt='test', data_path=data_path, target_path=target_path, indexes_path=indexes_path)
